<title>  Event | <?php echo $this->config->item('app_name'); ?></title>
<script>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url() ?>admin/event/save" method="post" class="form-horizontal" enctype="multipart/form-data" id="eventForm" >
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <select name="event_type_id" id="select" class="form-control">
														...
														?><option value="<?php echo $et->event_type_id ?>"><?php echo $et->event_type_name ?></option><?php }
                                                        ?>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    <input type="text" id="text-input" placeholder="Title " name="title"  class="form-control">
											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-5">
                                                    <input type="date" id="text-input" placeholder="" name="event_date"  class="form-control">
                                                    <small class="form-text text-muted">Select the event date</small>
												</div>
												
												<div class="col-12 col-md-4">
                                                    <input type="time" id="text-input" placeholder="" name="event_time"  class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="purpose" id="textarea-input" rows="5" placeholder="Purpose..." class="form-control"></textarea>
                                            ...
                                            <div class="row form-group">
												...
												<div class="col-12 col-md-3">
                                                    <input type="text" id="email-input" name="contact_person" placeholder="Contact Person" class="form-control">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    <input type="number" id="email-input" name="mobile" placeholder="Contact Number" class="form-control">
