    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">        
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <span class="fa fa-circle" style="color: orange"></span> Waiting form admin confirmation
                </div>
                <div class="col-lg-3">
                    <span class="fa fa-circle" style="color: gray"></span> Rejected from admin
                </div>
                <div class="col-lg-2">
                            ...
                            <tbody>
                                ...
                                foreach ($complaint as $c) {
                                    ...
                                    <tr>
                                        <td><?php echo $srno ?></td>
                                        <td>
                                            <?php if ($c->resolve == null && $c->resolve_confirm == null) {
                                                ?>
                                                <span class="fa fa-circle" style="color: red"></span>
                                                <?php
                                            } else if ($c->resolve != null && $c->resolve_confirm == null) {
                                                ?>
                                                <span class="fa fa-circle" style="color: orange"></span>
                                                <?php
                                            } else if ($c->resolve != null && $c->resolve_confirm == '0') {
                                                ?>
                                        ...
                                        <td><a href="<?php echo base_url() ?>complaint/detail?complaint_id=<?php echo $c->complaint_id ?>"><?php echo $c->complaint_id; ?></a></td>
